...
int main(int argc, char *argv[]) {
  ...
  addrCriteria.ai_family = AF_UNSPEC;             // Any address family, AF_UNSPEC indicates getaddrinfo() should return socket addresses for any address family that can be used with node and service. 
  // For the following fields, a zero value means "don't care"
  addrCriteria.ai_socktype = SOCK_DGRAM;          // Only datagram sockets, specifying 0 indicates that socket address of any type can be return by getaddrinfo().
